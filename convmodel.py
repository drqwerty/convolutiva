...
example_batch_train, label_batch_train = dataSource(["data3/0/*.jpg", "data3/1/*.jpg"], batch_size=batch_size)
example_batch_valid, label_batch_valid = dataSource(["data3/0/*.jpg", "data3/1/*.jpg"], batch_size=batch_size)
